                        ...
                        <div class="col-md-8">
                            <div class="card" id="htmlContent">
                                <div class="card-header bg-info text-white">
                                    <h3 class="text-center mb-0 font-weight-bold">CPRI Test Report</h3>
                                </div>
                                ...
                                if ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h5 class="font-weight-bold">CPRI Tested ID:</h5>
                                                <p><?= $row['cpri_test_id'] ?></p>
                                            </div>
                                            <div class="col-md-6">
                                                <h5 class="font-weight-bold"> Internal Tested id:</h5>
                                                <p><?= $row['test_id'] ?></p>
                                            </div>
                                            <div class="col-md-6">
