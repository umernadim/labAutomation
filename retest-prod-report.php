...
<head>
    ...
    <title>Lab Automation | Report</title>
                        ...
                        <div class="col-md-8">
                            <div class="card" id="htmlContent">
                                <div class="card-header bg-info text-white">
                                    <h3 class="text-center mb-0 font-weight-bold">Retest Product Report</h3>
                                </div>
                                ...
                                if ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h5 class="font-weight-bold">Test_type:</h5>
                                                <p><?= $row['test_type'] ?></p>
                                            </div>
                                            <div class="col-md-6">
                                                <h5 class="font-weight-bold">Test_criteria:</h5>
                                            ...
                                            <div class="col-md-6">
                                                <h5 class="font-weight-bold">Retested At:</h5>
                                                <p><?= $row['retest_date'] ?></p>
                                            </div>
